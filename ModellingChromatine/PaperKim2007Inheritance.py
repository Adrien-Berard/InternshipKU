...
class Chromatine:
    ...
    def Replication(self):
        for histone in range(chromatine_size):
...
csv_filename = os.path.join(current_directory, f'DNARepModelCenHsize_{CenHsize}_Density_{MCenHDensity}_polymerasecount_{polymerase_count}_F_{F}_addingpolyprobaintercept_{intercept}_addingpolyprobaslope_{slope}.csv')
