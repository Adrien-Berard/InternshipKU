...
class Chromatine:
    ...
    def BurstPoly(self,num_poly_burst, existing_polymerase_positions):
...
columns = ['Time Steps', 'Polymerase Count', 'Active Histone Count', 'Acetylated Histone Count',
           'Methylated Histone Count', 'Unmodified Histone Count', 'Noisy Changes Count', 'Enzyme Changes Count','Cromatine Array','A in gene']
...
csv_filename = os.path.join(current_directory, f'ScanCenH_Proba_{MCenHProb}_polymerasecount_{polymerase_count}_F_{F}_newpolyproba_{new_poly_probability}.csv')
